...
#SBATCH --time=9:00:00           # Increased time for longer training with larger batches
#SBATCH --mem=256gb
#SBATCH --nodes=1
...
python3 train_operator_AR_rell2_2d.py --config_path ${CONFIG_PATH} --test_seed ${SEED}
