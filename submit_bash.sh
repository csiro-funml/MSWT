...
CUDA_VISIBLE_DEVICES=0 python3 -u NSE/test_AR_NO_Dedalus.py --dataset ns2d_dedalus_big --model HFS --T_in 1 --T_out 1 --normalize 1 --normalize_strategy zscore --form velocity --batch_size 64 --epochs 1000 --num_workers 8 --pin_memory --prefetch_factor 1 --warmup_epochs 0 --num_steps 30 --save_type pth
