...
#SBATCH --time=00:40:00           # Increased time for longer training with larger batches
...
python3 SW2D_PDA_lightning/train.py --config_path SW2D_PDA/configs/MSWT_periodic.yaml --test_ratio 0.25 --devices 0,1,2,3 --accelerator gpu --strategy ddp
#################################################################################################################################
