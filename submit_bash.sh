...
#SBATCH --time=23:59:00           # Increased time for longer training with larger batches
...
#     --form velocity --batch_size 64 --gradient_accumulation_steps 4 --epochs 1000 --num_workers 8 --pin_memory --prefetch_factor 1 # Disabled for now
