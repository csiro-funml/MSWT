...
if __name__ == "__main__":
    # pred_path = 'operator_learning_model/FNO_ns2d_dedalus_ntrain4968/test_data_prediction.npz'
    pred_path  ='/test_data_prediction.npz'
    print("Loading both pred and ground truth from npz ", pred_path)
    load_data(pred_path, h5_path=None, load_both=True)
    
    # h5_path = 'realisation_0000/snapshots/snapshots_s1.h5'
