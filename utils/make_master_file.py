...
# DATASET_DICT[name] = {'train_path': './data/large/ns2d_pdb_M1_eta1e-2_zeta1e-2_train.hdf5', 'test_path': './data/large/ns2d_pdb_M1_eta1e-2_zeta1e-2_test.hdf5'}
DATASET_DICT[name] = {'train_path': '/scratch3/wan410/operator_learning_data/pdebench/ns2d_pdb_M1_eta1e-2_zeta1e-2/train', 'test_path': '/scratch3/wan410/operator_learning_data/pdebench/ns2d_pdb_M1_eta1e-2_zeta1e-2/test'}
# DATASET_DICT[name] = {'train_path': '/datasets/opb/pretrain/ns2d_pdb_M1_eta1e-2_zeta1e-2/train', 'test_path': '/datasets/opb/pretrain/ns2d_pdb_M1_eta1e-2_zeta1e-2/test'}
DATASET_DICT[name]['train_size'] = 9000
DATASET_DICT[name]['test_size'] = 200       ### default 200, maximum 1000
DATASET_DICT[name]['scatter_storage'] = True
...
if not torch.cuda.is_available():
    DATASET_DICT[name] = {'train_path': './pdearena/ns2d_pda/train', 'test_path': './pdearena/ns2d_pda/test'}
else:
...
DATASET_DICT[name]['scatter_storage'] = True
DATASET_DICT[name]['t_test'] = 50   ## predict 10 timesteps for testing
DATASET_DICT[name]['t_in'] = 4     ## use 10 as prefix steps, not necessary used
...
name= 'ns2d_cno'
if not torch.cuda.is_available():
    DATASET_DICT[name] = {'data_path': 'pdearena/cno_ns2d'}
else:
...
if not torch.cuda.is_available():
    # DATASET_DICT[name] = {'train_path': './data/large/pdearena/sw2d_pda/train', 
                            ...
                            # 'val_path': './data/large/pdearena/sw2d_pda/val',
    DATASET_DICT[name] = {'data_path': '/scratch3/wan410/operator_learning_data/Dedalus/Forcing', 
                            'train_raw_path': ['/datasets/work/oa-tcch/work/forMichaelwith-forcing/realisation_000%i/snapshots/snapshots_s1'%i for i in range(8)],
                            'val_raw_path': ['/datasets/work/oa-tcch/work/forXuesong/with-forcing/realisation_0008/snapshots/snapshots_s1'],
                            'test_raw_path': ['/datasets/work/oa-tcch/work/forXuesong/with-forcing/realisation_0009/snapshots/snapshots_s1'],
                            'test_long_raw_path': ['/datasets/work/oa-tcch/work/forXuesong/with-forcing/long/realisation_0000/snapshots/snapshots_s1'],
                          }
else:
    DATASET_DICT[name] =  {'data_path': '/scratch3/wan410/operator_learning_data/Dedalus/Forcing', 
                            'train_raw_path': ['/datasets/work/oa-tcch/work/forXuesong/with-forcing/realisation_000%i/snapshots/snapshots_s1'%i for i in range(8)],
