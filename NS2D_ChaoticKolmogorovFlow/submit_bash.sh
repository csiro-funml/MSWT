...
#SBATCH --time=04:30:00           # Increased time for longer training with larger batches
...
# Ablations
# python3 train_operator_AR_rell2_2d.py --config_path configs/ablations/rebutall/MSWT_no_attention.yaml --test_seed 42 --test_ratio 0.25
python3 train_operator_AR_rell2_2d.py --config_path configs/ablations/rebutall/MSWT_no_tokenizer.yaml --test_seed 42 --test_ratio 0.25
# python3 train_operator_AR_rell2_2d.py --config_path configs/ablations/rebutall/MSWT_strided_up_downsampling.yaml --test_seed 42 --test_ratio 0.25
