...
# python3 train_operator_AR_rell2_2d.py --config_path configs/MSWT_double_attn.yaml --test_ratio 0.25
# python3 train_operator_AR_rell2_2d.py --config_path configs/MSWT_NodecoderAttn_Group4.yaml --test_ratio 0.25
#################################################################################################################################
