...
# Default values
CONFIG_PATH="${1:-configs/MSWT_sphere.yaml}"
TEST_RATIO="${2:-0.25}"
...
# python3 2d_train_rel_l2.py --config_path ${CONFIG_PATH} --seed ${SEED}
python3 2d_test_rel_l2.py --config_path ${CONFIG_PATH} --seed ${SEED}
