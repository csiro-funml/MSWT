...
def update_lr(optimizer, scheduler1, scheduler2,  epoch):
    """
    Fixing the learning rate (8e-4) for the first 120 epochs,  then use scheduler1 between 120-200 epochs,  fixed it again at 200 epochs,
    and use scheduler2 after 250 epochs.
    """
    ...
    return lr_new, scheduler1, scheduler2
...
for ep in pbar:
    ...
    for batch_id, (xx, yy) in enumerate(train_loader):
        ...
        lr, scheduler1, scheduler2 = update_lr(optimizer, scheduler1, scheduler2, ep)
